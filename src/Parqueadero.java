...
// -----------------------------------------------------------------
    ...
    public double darTiempoPromedio(){
            ...
            return totalCarros > 0 ? horasTotales / totalCarros : 0;
    }
    ...
    if(count > 0) {
        System.out.println("There are " + count + " cars that have been parked for more than 8 hours.");
        return true;
    } else {
        System.out.println("There are no cars that have been parked for more than 8 hours.");
        return false;
    }
}
...
public boolean hayCarrosPlacaIgual( ) {
    ...
    System.out.println("There are " + count + " cars with license plates starting with 'PB'.");
    return count;
    }
